...
A bilingual, searchable library catalogue for a historic 1918 library in Kolkata. Built from scratch with live search, responsive design, and smart Hinglish-to-Hindi transliteration.
...
- Implements smart Hinglish-to-Hindi transliteration – so searching "kela prasad" finds "केला प्रसाद" without broken Google Translate nonsense
...
- 🏛️ Executive Committee Management – dynamic member profiles (planned)
...
2. Bilingual intelligence – Hinglish-to-Hindi transliteration without breaking Google Translate
